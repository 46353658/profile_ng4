...
export class UserService {
  private userInfo = {
    ...
    to the contact centre's front end in Angular and Electron. 
    
    I've worked in various programming languages/frameworks and have system's Analysis experience.
    
    I'm currently employed by Entelect working on devOps and server side Java for Standard Bank's Web and Mobile platforms.`,
